...
if __name__ == '__main__':
	...
	if args.play or args.agent == 'Human':
		print("--SOLVING [ " + LEVEL_DIR + " ] LEVEL [ " + str(args.levelNo) + " ] AS HUMAN PLAYER--")
		print("\n** CONTROLS **")
	...
	#agent solve
		...
		if args.agent == 'DoNothing':
			print("--SOLVING [ " + LEVEL_DIR + " ]  LEVEL [ " + str(args.levelNo) + " ] WITH [ DO-NOTHING AGENT ] for [ " + str(args.maxIter) + " ] ITERATIONS--")
			ai_play(args.levelNo, DoNothingAgent(), args.maxIter, args.speed, args.no_rend)
		elif args.agent == 'Random':
			print("--SOLVING [ " + LEVEL_DIR + " ]  LEVEL [ " + str(args.levelNo) + " ] WITH [ RANDOM AGENT ] for [ " + str(args.maxIter) + " ] ITERATIONS--")
			ai_play(args.levelNo, RandomAgent(), args.maxIter, args.speed, args.no_rend)
		elif args.agent == 'BFS':
			print("--SOLVING [ " + LEVEL_DIR + " ]  LEVEL [ " + str(args.levelNo) + " ] WITH [ BFS AGENT ] for [ " + str(args.maxIter) + " ] ITERATIONS--")
			ai_play(args.levelNo, BFSAgent(), args.maxIter, args.speed, args.no_rend)
		elif args.agent == 'DFS':
			print("--SOLVING [ " + LEVEL_DIR + " ]  LEVEL [ " + str(args.levelNo) + " ] WITH [ DFS AGENT ] for [ " + str(args.maxIter) + " ] ITERATIONS--")
			ai_play(args.levelNo, DFSAgent(), args.maxIter, args.speed, args.no_rend)
		elif args.agent == 'AStar':
			print("--SOLVING [ " + LEVEL_DIR + " ]  LEVEL [ " + str(args.levelNo) + " ] WITH [ ASTAR AGENT ] for [ " + str(args.maxIter) + " ] ITERATIONS--")
			ai_play(args.levelNo, AStarAgent(), args.maxIter, args.speed, args.no_rend)
		elif args.agent == 'HillClimber':
			print("--SOLVING [ " + LEVEL_DIR + " ]  LEVEL [ " + str(args.levelNo) + " ] WITH [ HILLCLIMBER AGENT ] for [ " + str(args.maxIter) + " ] ITERATIONS--")
			ai_play(args.levelNo, HillClimberAgent(), args.maxIter, args.speed, args.no_rend)
		elif args.agent == 'Genetic':
			print("--SOLVING [ " + LEVEL_DIR + " ]  LEVEL [ " + str(args.levelNo) + " ] WITH [ GENETIC AGENT ] for [ " + str(args.maxIter) + " ] ITERATIONS--")
			ai_play(args.levelNo, GeneticAgent(), args.maxIter, args.speed, args.no_rend)
		elif args.agent == 'MCTS':
			print("--SOLVING [ " + LEVEL_DIR + " ]  LEVEL [ " + str(args.levelNo) + " ] WITH [ MCTS AGENT ] for [ " + str(args.maxIter) + " ] ITERATIONS--")
